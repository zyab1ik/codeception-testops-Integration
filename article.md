...
P/s В качестве решения валидации аннотаций, можно посоветовать установить плагин для phpStoprm

- [PHP Annotations](https://plugins.jetbrains.com/plugin/7320-php-annotations), который поможет найти подобные ошибки,
